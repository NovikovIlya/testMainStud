...
import { DeleteOutlined, PlusCircleOutlined } from '@ant-design/icons'
import { Button, Form, Input, Popconfirm, Select, Spin, Switch, Tooltip, ConfigProvider } from 'antd'
import { useTranslation } from 'react-i18next'
...
const ContactDataBlock = ({ isLoadingPost, sortedEmails, sendVer, handleDeleteEmail, showModal ,text}: any) => {
