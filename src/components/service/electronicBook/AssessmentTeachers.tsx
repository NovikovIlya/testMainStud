...
import {useGetTeacherInfoQuery, useGetTeachersRatingQuery} from "../../../store/api/serviceApi";
import {SetStateAction, useEffect, useState} from "react";
import {ITeacher} from "../../../store/type";
...
export const AssessmentTeachers = () => {
    ...
    console.log(typeof teacherData?.rating["Доброжелательность и тактичность"])
					...
					w-full`}>
						...
						mt-5`}>
							...
							justify-between`}>
								...
								items-center`}>
                                    <Rate
                                        className={`text-[${blue307}]`}/>
                                    <p>{teacherData?.rating["Доброжелательность и тактичность"]}</p>
                                </div>
                            </div>
                            <div className={`
							flex 
							justify-between`}>
								...
								items-center`}>
                                    <Rate
                                        className={`text-[${blue307}]`}/>
                                    <p>{teacherData?.rating["Общая эрудиция"]}</p>
                                </div>
                            </div>
                            <div className={`
							flex 
							justify-between`}>
								...
								items-center`}>
                                    <Rate
                                        className={`text-[${blue307}]`}
                                    />
                                    <p>{teacherData?.rating["Внешний вид и манера поведения"]}</p>
                                </div>
                            </div>
                            <div className={`
							flex 
							justify-between`}>
								...
								items-center`}>
                                    <Rate
                                        className={`text-[${blue307}]`}/>
                                    <p>{teacherData?.rating["Пунктуальность"]}</p>
                                </div>
                            </div>
                        </div>
                        <div className={`
