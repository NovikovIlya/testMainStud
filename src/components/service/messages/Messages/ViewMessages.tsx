...
export const ViewMessage = () => {
	...
	const { data: dataAllDialogsOld } = useGetAllDialogsOldQuery({ page, size: 9 })
	const {data: dataAllDialogs,isLoading,isFetching} = useGetAllDialogsQuery({ page: 0, size: 9 }, { pollingInterval: 2000 })
