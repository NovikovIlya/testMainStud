...
export const DirectResume = ({
	...
	const onSubmit: SubmitHandler<formDataType> = data => {
		...
		fetch('http://localhost:8082/employment-api/v1/resume', {
			...
			headers: {
				Authorization:
					'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..4dmYBUEDz9UzKxvxWtQhA6poTVwFOkRn-YoSzngfVUs'
			}
		}).then(response => {
			if (response.ok) {
				setIsOpen(false)
