  ...
  return (
    <div className='Autoris__General'>
      <div className='TopBlock'>
        ...
        <Link to="/" className='CloseLink'><CloseOutlined className='CloseIcon'/></Link>
      </div>
      <div className='MiddleBlock'>
        <div className={RememberPass ? classNames('MainText', 'justify-start') : classNames('MainText', 'justify-center')}>
          {RememberPass
            ? Language==="RU"
              ? "Напомнить пароль"
              : "Remember password"
        ...
        <div className='InputBlock'>
          ...
          : "SeparateInput"
            ...
            />
            {Error.EmailError && <div className='ErrorText'>
              {RememberPass
                ? Language==="RU"
          ...
          {(!IsSend && RememberPass) && <div className='flex w-full h-auto flex-wrap'>
            {Language==="RU"
          ...
          <div className={RememberPass ? 'hidden' : 'SeparateInput'}>
            <div className={PassValue.length > 0 ? 'Caption' : 'hidden'}>{Language==="RU" ? "Пароль" : "Password"}</div>
            <Input.Password
              className={
                PassValue.length > 0 
                  ? classNames('input', 'pt-4') 
            ...
            />
            {Error.PassError && <div className='ErrorText'>
              {Language==="RU"
                ? "Укажите пароль"
                : "Enter password"
              }
        ...
        <div 
          ...
          onClick={() => {ChangeRemember(!RememberPass); ChangeEmail("")}}>
          {Language==="RU"
            ? "Не помню пароль"
