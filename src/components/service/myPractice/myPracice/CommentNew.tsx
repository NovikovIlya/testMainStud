								...
								{isStudent ? (
									<div className="flex mb-10">
										<div className="flex flex-col items-end">
											...
											<div className="bg-blue-500 text-white rounded-lg rounded-tr-none p-3 flex flex-wrap  ">
									...
									<>
										...
										<div className="flex flex-col">
											...
											<div className="bg-gray-200 rounded-lg rounded-tl-none p-3  flex flex-wrap">
												<div className='break-all'>{message.text}</div>
