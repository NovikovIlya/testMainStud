...
export const RegisterContracts = () => {
    ...
    const { data:dataMest,isFetching:isFetchingMest}= useGetMestQuery()
    ...
    const columnsFullView: TableProps<ColumnsTableFull>['columns'] = [
        ...
        },
        {
            ...
            render: (value, record, index) => {
                ...
                // @ts-ignore
                return (record?.specialtyNames?.map((item: string) => item?.value).join(', '))
            }
   ...
   console.log('check,',check)
    ...
    function changeListDataAll(elem: any) {
        const newElem: any = {
            ...
            specialtyNames: elem?.specialtyNames,
