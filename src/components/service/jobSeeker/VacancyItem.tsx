...
export default function VacancyItem(props: VacancyItemType) {
	...
	return (
		<div className="flex w-full bg-white pl-[20px] pr-[105px] pt-[20px] pb-[20px] items-center shadow-custom-shadow">
			...
			<button
				className="ml-auto bg-button-blue hover:bg-button-blue-hover focus:border-[2px] focus:border-button-focus-border-blue font-content-font font-normal text-[16px]/[16px] text-white text-center w-[127px] h-[32px] pt-[8px] pb-[8px] pl-[24px] pr-[24px] rounded-[54px]"
				onClick={() => {
					getVacancy(props.id)
						.unwrap()
						.then(result => {
