	...
	return (
		<>
			...
			>
				...
				>
					<div className="min-h-[10vh] max-h-[60vh] overflow-auto">
						...
						{pathname.includes('/services/jobseeker/vacancyview/respond/aboutme') && (
							<Form
								...
								initialValues={{
									...
									patronymic: aboutMeData.patronymic,
									birthDay: aboutMeData.birthDay
										? dayjs(aboutMeData.birthDay.split('.').join('-'), 'DD.MM.YYYY')
										: null,
							...
							>
								...
								<Form.Item
									name={'patronymic'}
									label={
										<label className="text-black text-[18px]/[18px] font-content-font font-normal">Отчество</label>
									}
						...
						{pathname.includes('/services/jobseeker/vacancyview/respond/experience/add') && (
							...
							>
								...
								<Form.Item
									...
									label={
										<label className="text-black text-[18px]/[18px] font-content-font font-normal">Должность</label>
									}
								>
									<Input
										onPressEnter={e => {
