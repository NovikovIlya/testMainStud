		...
		<ImagesLayout>
			<div className="w-full flex justify-center ">
				<div className="container max-w-2xl flex flex-col items-start justify-center p-5">
					...
					<Input placeholder="+7 999 898-88-00" size="large" className="mt-2" />
					<div className="text-black text-[14px] font-normal mt-4">
						Email родителя
					</div>
					<Input placeholder="BezuPr@gmail.com" size="large" className="mt-2" />
					...
					<div className="grid grid-cols-2">
						<div className="mt-4">
							...
							<Input placeholder="000-000" size="large" className="mt-2" />
						</div>
						<div className="mt-4">
							<div className="text-black text-[14px] font-normal">
								Когда выдан
